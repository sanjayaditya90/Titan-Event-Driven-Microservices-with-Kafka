...
public class PaymentConsumer {
	...
	public void consume(String message) {
		...
		System.out.println("-----------------------------------------");
		System.out.println("Reading message from Payment Service Kafka");
		System.out.println("Event Id : " + event.getEventId());
		System.out.println("Order No : " + event.getOrderNo());
		System.out.println("Payment Mode : " + event.getPaymentMethod());
		System.out.println("Amount : " + event.getAmount());
		System.out.println("Message Read from Payment Service Kafka");
		System.out.println("-----------------------------------------");

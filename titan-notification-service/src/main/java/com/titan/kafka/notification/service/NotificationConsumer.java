...
public class NotificationConsumer {
	...
	public void consumeOrderCreated(String message) {
		...
		System.out.println("-----------------------------------------");
		System.out.println("Reading message from Notification Service Kafka");
		System.out.println("Event Id : " + event.getEventId());
		System.out.println("Order No : " + event.getOrderNo());
		System.out.println("Mobile No : " + event.getMobileNo());
		System.out.println("Amount : " + event.getAmount());
		System.out.println("Email : " + event.getEmail());
		System.out.println("Message Read from Notification Service Kafka");
		System.out.println("-----------------------------------------");

		String response = notificationService.process(event);
